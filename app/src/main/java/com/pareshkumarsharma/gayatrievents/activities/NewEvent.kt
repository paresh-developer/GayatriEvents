...
//        }
        ...
        if(Operation=='U'){
            ...
            val tbl1 = Database.query("Select Title,Price from SERVICE_PRODUCT where Id = $ServiceProduct_Id")
        ...
        findViewById<Button>(R.id.btnSaveNewEvent).setOnClickListener {
            ...
            val event_date_fixed = findViewById<RadioButton>(R.id.chkEventDateFixed).isChecked
            val event_date_start_day = findViewById<NumberPicker>(R.id.nmDay_Start).value
            val event_date_start_month = findViewById<NumberPicker>(R.id.nmMonth_Start).value
            val event_date_start_year = findViewById<NumberPicker>(R.id.nmYear_Start).value
            val event_date_end_day = findViewById<NumberPicker>(R.id.nmDay_End).value
            val event_date_end_month = findViewById<NumberPicker>(R.id.nmMonth_End).value
